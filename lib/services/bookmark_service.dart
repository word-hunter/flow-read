...
class BookmarkService {
  ...
  List<BookmarkedWord> loadWordBookmarks(String bookId) {
    ...
    try {
      ...
      return list.map((e) => BookmarkedWord(
  ...
  Future<void> saveWordBookmarks(String bookId, List<BookmarkedWord> bookmarks) async {
  ...
  List<ReadingBookmark> loadReadingBookmarks(String bookId) {
    ...
    try {
      final list = jsonDecode(json) as List<dynamic>;
      return list.map((e) => ReadingBookmark(
  ...
  Future<void> saveReadingBookmarks(String bookId, List<ReadingBookmark> bookmarks) async {
    final list = bookmarks.map((b) => {
